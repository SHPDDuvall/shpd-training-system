...
function mapRequestFromDb(data: Record<string, unknown>): TrainingRequest {
  ...
  return {
    ...
    step1Id: data.step1_id as string | undefined,
    step1Name: data.step1_name as string | undefined,
    step1Title: data.step1_title as string | undefined,
    step1ApprovalDate: data.step1_approval_date as string | undefined,
    step2Id: data.step2_id as string | undefined,
    step2Name: data.step2_name as string | undefined,
    step2Title: data.step2_title as string | undefined,
    step2ApprovalDate: data.step2_approval_date as string | undefined,
    step3Id: data.step3_id as string | undefined,
    step3Name: data.step3_name as string | undefined,
    step3Title: data.step3_title as string | undefined,
    step3ApprovalDate: data.step3_approval_date as string | undefined,
    step4Id: data.step4_id as string | undefined,
    step4Name: data.step4_name as string | undefined,
    step4Title: data.step4_title as string | undefined,
    step4ApprovalDate: data.step4_approval_date as string | undefined,
    step5Id: data.step5_id as string | undefined,
    step5Name: data.step5_name as string | undefined,
    step5Title: data.step5_title as string | undefined,
    step5ApprovalDate: data.step5_approval_date as string | undefined,
    originalData: data,
